  ...
  render() {
    ...
    return (
      <View style={[styles.container, this.props.style]} onLayout={this._handleLayout}>
        ...
        <ReAnimated.Code
          exec={ReAnimated.block([
            ReAnimated.cond(ReAnimated.defined(this.props.parentAnimationValue), [
              ReAnimated.set(this.props.parentAnimationValue, this.reScrollValue),
            ]),
            ReAnimated.call([this.reScrollXIOS, this.reScrollValue], (value) => {
...
export default GScrollableTabView
